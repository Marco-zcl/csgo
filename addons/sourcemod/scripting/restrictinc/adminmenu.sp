...
public OnAdminMenuReady(Handle:topmenu)
{
	...
	AddToTopMenu(hAdminMenu, "sm_knives", TopMenuObject_Item, AdminMenu_Knives, menu, "sm_knives", ADMFLAG_GENERIC);
	AddToTopMenu(hAdminMenu, "sm_pistols", TopMenuObject_Item, AdminMenu_Pistols, menu, "sm_pistols", ADMFLAG_GENERIC);
}
